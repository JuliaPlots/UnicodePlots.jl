...
======
    ...
    stairs(x, y; style = :post, title = "", name = "", width = 40, height = 15, border = :solid, xlim = [0, 0], ylim = [0, 0], margin = 3, padding = 1, color = :green, labels = true, canvas = BrailleCanvas, grid = true)
