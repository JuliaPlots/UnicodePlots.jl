...
rgb2ansi(v::Integer) = v >= THRESHOLD ? v - THRESHOLD : v
...
blend_colors(a::UInt32, b::UInt32)::UInt32 = (
...
crayon_color(::Missing) = Crayons.ANSIColor()
crayon_color(::Nothing) = Crayons.ANSIColor()
crayon_color(color::UInt32) = (
