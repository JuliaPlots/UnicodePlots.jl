...
@inline function init_borders()
  global const borderMap = Dict{Symbol,Dict{Symbol,UTF8String}}()
  global const borderSolid = Dict{Symbol,UTF8String}()
  global const borderBold = Dict{Symbol,UTF8String}()
  global const borderNone = Dict{Symbol,UTF8String}()
  global const borderDashed = Dict{Symbol,UTF8String}()
  global const borderDotted = Dict{Symbol,UTF8String}()
  global const borderAscii = Dict{Symbol,UTF8String}()
  borderSolid[:tl]="┌"
  borderSolid[:tr]="┐"
  borderSolid[:bl]="└"
  borderSolid[:br]="┘"
...
@inline function init_colors()
  global const colorEncode = Dict{Symbol,UInt8}()
  global const colorDecode = Dict{UInt8,Symbol}()
