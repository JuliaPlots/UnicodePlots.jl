...
barplot([:Please,:dont,:crash,:dude], [10,24,1,13], width=10, marigin=0)
barplot([:Please,:dont,:crash,:dude], [10,24,1,13], width=10, marigin=20)
...
lineplot(x, y, width=50, height=5, marigin=0)
lineplot(x, y, width=10, height=20, marigin = 20)
