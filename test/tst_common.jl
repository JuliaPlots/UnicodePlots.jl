...
@testset "miscellaneous" begin
    ...
    @test UnicodePlots.nice_repr(-1_000_000_000, nothing) == "-1_000_000_000"
    @test UnicodePlots.nice_repr(-100_000_000, nothing) == "-100_000_000"
    @test UnicodePlots.nice_repr(-10_000_000, nothing) == "-10_000_000"
    @test UnicodePlots.nice_repr(-1_000_000, nothing) == "-1_000_000"
    @test UnicodePlots.nice_repr(-100_000, nothing) == "-100_000"
    @test UnicodePlots.nice_repr(-10_000, nothing) == "-10_000"
    @test UnicodePlots.nice_repr(-1_000, nothing) == "-1_000"
